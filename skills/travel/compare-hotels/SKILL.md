...
|--------|-----------|---------------|
| FHR properties | `~/.hermes/skills/travel/data/fhr-properties.json` | Check if a hotel is FHR before booking |
| THC properties | `~/.hermes/skills/travel/data/thc-properties.json` | Check if a hotel is THC |
| Chase Edit properties | `~/.hermes/skills/travel/data/chase-edit-properties.json` | Check if a hotel is in Chase's Edit program |
...
Cross-reference results with `~/.hermes/skills/travel/data/fhr-properties.json`, `~/.hermes/skills/travel/data/thc-properties.json`, and `~/.hermes/skills/travel/data/chase-edit-properties.json`:
...
| File | Purpose |
|------|---------|
| `~/.hermes/skills/travel/data/fhr-properties.json` | FHR property lookup by city/coordinates |
| `~/.hermes/skills/travel/data/thc-properties.json` | THC property lookup |
| `~/.hermes/skills/travel/data/chase-edit-properties.json` | Chase Edit property lookup |
| `~/.hermes/skills/travel/data/hotel-chains.json` | Hotel chain to loyalty program mapping |
| `~/.hermes/skills/travel/data/points-valuations.json` | CPP valuations for points calculations |
