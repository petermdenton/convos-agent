...
**Data file:** `~/.hermes/skills/travel/data/rtw-awards.json`. Contains 17 programs with confidence markers (VERIFIED / LIKELY) and primary-source citations.
...
(also encoded in `~/.hermes/skills/travel/data/rtw-awards.json` `decision_rules`)
