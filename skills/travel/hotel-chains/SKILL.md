...
**Reference data:** `~/.hermes/skills/travel/data/hotel-chains.json`
...
Reference `~/.hermes/skills/travel/data/sweet-spots.json` `booking_windows` section if a user wants to know how far in advance to book.
