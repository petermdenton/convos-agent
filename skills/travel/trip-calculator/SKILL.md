...
| File | Purpose |
|------|---------|
| `~/.hermes/skills/travel/data/points-valuations.json` | CPP valuations per program (floor/ceiling) |
| `~/.hermes/skills/travel/data/transfer-partners.json` | Credit card → loyalty program transfer ratios |
...
```bash
jq -r '.credit_card_points.chase_ultimate_rewards | "Chase UR: floor \(.floor)cpp, ceiling \(.ceiling)cpp"' ~/.hermes/skills/travel/data/points-valuations.json
```
...
```bash
jq -r '.credit_card_points.chase_ultimate_rewards.floor' ~/.hermes/skills/travel/data/points-valuations.json
```
...
POINTS=75000
FLOOR=$(jq -r '.credit_card_points.chase_ultimate_rewards.floor' ~/.hermes/skills/travel/data/points-valuations.json)
