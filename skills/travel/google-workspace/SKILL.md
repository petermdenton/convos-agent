...
```bash
GSETUP="python ${HERMES_HOME:-$HOME/.hermes}/skills/travel/google-workspace/scripts/setup.py"
```
...
```bash
GAPI="python ${HERMES_HOME:-$HOME/.hermes}/skills/travel/google-workspace/scripts/google_api.py"
```
